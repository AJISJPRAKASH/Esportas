 <?php
                            ...
                            if (isset($_GET['delete']))
                            {
                                ...
                                $id=$_GET['delete'];
                                $sql="DELETE FROM $ename WHERE chessno='$id'";
...
<body>
  <header>
    <p align="right"><a href="adminhome.php"> <button type="button" class="btn btn-info  btn-sm">Home</button></a>
</header>
...
<CENTER><h1 class="display-4 ">Registration Details</h1></CENTER>
   ...
   <?php
     while( $row = mysqli_fetch_assoc( $result ) ) : ?>
      ...
      <td> <a href="registrationdetail.php?edit=<?php echo $row['chessno']; ?>" class="btn btn-info">Edit</a></td>
              

       <td> <a href="registrationdetail.php?delete=<?php echo $row['chessno']; ?>" class="btn btn-danger">Delete</a></td>
