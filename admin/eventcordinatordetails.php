...
<body>
    <header class=" jmp-style text-center" style="margin-bottom:0">
             ...
             <button type="button" class="btn btn-primary" onclick="window.location.href='index.php'">Sign out</button>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" value="<?php echo $uname; ?>" placeholder="Event Name*" name="uname"  />
                                            </div>
                                            <div class="form-group">
                                                
                                                <input type="text" class="form-control" value="<?php echo $pswd; ?>" placeholder=" Event Time*" name="pswd" />
                                            </div>                                                                                                                                
                                        </div>
                                        <div class="col-md-6">
     ...
     <?php
                    ...
                    $sql="SELECT * FROM eventcordinator";
    ...
    <CENTER><h1 class="display-4 "> USER Table</h1></CENTER>
        ...
        <?php
          while( $row = mysqli_fetch_assoc( $result ) ) : ?>
            ...
            <td>
              <a href="eventcordinatordetails.php?edit=<?php echo $row['SI']; ?>" class="btn btn-info">Edit</a>
              
              
              <a href="eventcordinatordetails.php?delete=<?php echo $row['SI']; ?>" class="btn btn-danger">Delete</a>
              <?php
                    ...
                    if (isset($_GET['delete']))
                    {
                        ...
                        $id=$_GET['delete'];
                        $sql="DELETE FROM eventcordinator WHERE SI='$id'";
                    ...
                    if (isset($_POST['update']))
                    {
                        ...
                        $uname = $_POST['uname'];
                        $pswd = $_POST['pswd'];
                        echo $uname; echo $pswd;
                        $sql="UPDATE eventcordinator SET  username='$uname',password='$pswd' WHERE SI='$id'";
                        $rs = mysqli_query($cn, $sql);
