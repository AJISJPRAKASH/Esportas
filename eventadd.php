        ...
        <?php
          while( $row = mysqli_fetch_assoc( $result ) ) : ?>
            ...
            <td><?php echo $row['event_time']; ?></td>
              <td>
              <a href="admin3.php?edit=<?php echo $row['event_name']; ?>" class="btn btn-info">Edit</a>
              

              <a href="admin3.php?delete=<?php echo $row['event_name']; ?>" class="btn btn-danger">Delete</a>
              <?php
